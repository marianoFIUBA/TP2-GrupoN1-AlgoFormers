...
//                casilleroActual.alojarAlternoPorTierra(algoformer);
    ...
    /*public void atacarA(AlgoFormer algoformer) {
        ...
        *//*if (this.modoPostPsionico){
        ...
        if (this.calculo.estaEnRango(this.obtenerCasillero(), algoformer.obtenerCasillero(), puntosDeAtaque)){     // Puntos de ataque como parametro del estaEnRango estaba bien?
