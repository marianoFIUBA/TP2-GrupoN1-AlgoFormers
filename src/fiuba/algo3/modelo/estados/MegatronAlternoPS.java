 ...
 */
public class MegatronAlternoPS implements EstadoAlgoFormer, AlternoAereo{

    private int puntosDevida;

    private int puntosDeAtaque = 33; //Ataque reducido en un 40%
    ...
    public MegatronAlternoPS (int puntosDeVida, Casillero casillero){
